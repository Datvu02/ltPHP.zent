                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Article list
                                <a href="posts_add.php?" style="float: right" class="btn btn-success">add to posts</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <img src="../images/<?= $pst['thumbnall'] ?>" width="100px" height="100px" style="object-fit: cover;">
                                          </td>
